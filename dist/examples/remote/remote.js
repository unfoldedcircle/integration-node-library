...
import { COMMANDS as REMOTECOMMANDS, STATES as REMOTESTATES, ATTRIBUTES as REMOTEATTRIBUTES, FEATURES as REMOTEFEATURES } from "../../lib/entities/remote.js";
import { STATUS_CODES } from "http";
import { BUTTONS, createBtnMapping, UiPage, createUiText, createUiIcon, Size, EntityCommand } from "../../lib/entities/ui.js";
...
const createButtonMappings = () => {
    return [
        ...
        createBtnMapping(BUTTONS.BLUE, createSequenceCmd(["CURSOR_UP", "CURSOR_RIGHT", "CURSOR_DOWN", "CURSOR_LEFT"], { delay: 200 })),
...
const createUi = () => {
    ...
    uiPage2.add(createUiText("Test sequence", 0, 4, createSequenceCmd(["CURSOR_UP", "CURSOR_RIGHT", "CURSOR_DOWN", "CURSOR_LEFT"], { delay: 200 }), new Size(4, 1)));
