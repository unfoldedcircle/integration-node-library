 ...
 */
declare enum INTEGRATION_SETUP_ERROR {
    NONE = "NONE",
    NOT_FOUND = "NOT_FOUND",
 ...
 */
declare class UserConfirmationResponse extends SetupDriver {
    confirm: boolean;
 ...
 * Abort notification.
 */
declare class AbortDriverSetup extends SetupDriver {
    error: string;
 ...
 */
declare class RequestUserInput extends SetupAction {
    ...
    constructor(title: string | Map<string, string> | {
        [key: string]: string;
    }, settings: Array<{
        [key: string]: object | string;
    }>);
 ...
 */
declare class RequestUserConfirmation extends SetupAction {
    title: string | Map<string, string> | {
        [key: string]: string;
    };
    ...
    image?: string;
    footer?: string | Map<string, string> | {
        [key: string]: string;
    };
    constructor(title: string | Map<string, string> | {
        [key: string]: string;
        ...
        [key: string]: string;
    }, image?: string, footer?: string | Map<string, string> | {
        [key: string]: string;
    });
}
/**
 ...
 */
declare class SetupError extends SetupAction {
    errorType: string;
 ...
 */
declare class SetupComplete extends SetupAction {
}
export declare const setup: {
    SetupDriver: typeof SetupDriver;
    DriverSetupRequest: typeof DriverSetupRequest;
    UserDataResponse: typeof UserDataResponse;
    UserConfirmationResponse: typeof UserConfirmationResponse;
    AbortDriverSetup: typeof AbortDriverSetup;
    SetupAction: typeof SetupAction;
    RequestUserInput: typeof RequestUserInput;
    RequestUserConfirmation: typeof RequestUserConfirmation;
    SetupError: typeof SetupError;
    SetupComplete: typeof SetupComplete;
};
